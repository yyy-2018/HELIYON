# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 00:38:31 2024
...
def modelws(seed_numble):
    ...
    try:
        ...
        m.addGenConstrNorm(qs2,sbs2,2.0, "normconstr")
    ...
    msjlist.append(sum(c[i]*e[i].x for i in range(20)))
    ...
    # #PR
    # # print(sum(c[i]*e[i].x for i in range(20)))
    # #ocp-
    # print(round(oc1.x,3))
