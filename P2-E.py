# -*- coding: utf-8 -*-
"""
Created on Thu Apr 20 23:07:10 2023
...
sbs = t.addMVar(shape=4,lb=-float("inf"),name="sbs")
qs = t.addVar(name="qs")
...
t.addConstrs(e[i]*cbo[i] == sbs[i] for i in range(4))
...
# print(sum(c[i]*e[i].x for i in range(4))+qs.x)
print(round(oc1.x,3))
