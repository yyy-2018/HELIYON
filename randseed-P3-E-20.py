# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 00:39:47 2024
...
def modelws(seed_numble):
    ...
    dsjlist.append(-round(sum(-c[i]*x[i].x for i in range(20))+qs2.x,2))
    msjlist.append(round(sum(c[i]*e[i].x for i in range(20))+qs3.x,2))
    ...
    # # print(sum(c[i]*e[i].x for i in range(20))+qs3.x)
    # print(round(oc1.x,3))
